...
namespace PageControl.Pager
{
    public partial class MetroGrid : C1FlexGrid, IMetroControl
    {
        ...
        public bool DisplayAction
        {
            ...
            set { _displayaction = value; pnlAction.Visible = value; }
        }
        ...
        public MetroGrid()
        {
            ...
            if (this.Rows.Count > 1)
            {
                ...
                pnlAction.Location = new Point(_left, _top);
            }

            _horizontal.MouseLeave += Metro_MouseLeave;
            _vertical.MouseLeave += Metro_MouseLeave;

            this.lnkEdit.Click += lnkEdit_Click;
            this.lnkDelete.Click += lnkDelete_Click;
        }
        ...
        public delegate void ButDelClick(object sender, EventArgs e);
        public event ButDelClick DeleteClick;
        ...
        public delegate void ButEditClick(object sender, EventArgs e);
        public event ButEditClick EditClick;
        ...
        private void StyleGrid()
        {
            ...
            this.Styles.Fixed.Font = new Font("Segoe UI", 11f, FontStyle.Regular, GraphicsUnit.Pixel);//new Font("Tahoma", 9.0f);//MetroFonts.Label(MetroLabelSize.Small, MetroLabelWeight.Regular);
        ...
        void MetroGrid_RowColChange(object sender, EventArgs e)
        {
            ...
            if (this.Rows.Count > 1 && _displayaction)
            {
                ...
                pnlAction.Visible = _displayaction;
                pnlAction.Height = this.Rows[this.TopRow].HeightDisplay;
