...
#Region "Sub New"
        ...
        Sub New(ByVal server As String, ByVal database As String, ByVal userid As String, ByVal password As String, ByVal portno As String, ByVal filename As String)
            _server = server : _database = database : _userid = userid : _password = password : _portno = portno
            _parameters.Clear() : _filename = filename : _error = String.Empty : If _maxallowedpacket <= 0 Then _maxallowedpacket = 16
        End Sub
#End Region
...
#Region "Internal Functions"
        ...
        Public Function Export() As Boolean
            ...
            If CanExport Then
                ...
                With sw
                    .WriteLine("""" & Application.StartupPath & "\mysqldump"" --host=" & _server & " --user=" & _userid & " --password=" & _password & " " & " --port=" & _portno & " " & _database & sParam & " --set-charset --default-character-set=utf8 >" & """" & _filename & """")
                    .Close() : .Dispose()
                End With
        ...
        Public Function Import() As Boolean
            ...
            With sw
                .WriteLine("""" & Application.StartupPath & "\mysql"" -h " & _server & " -u " & _userid & " -p" & _password & " " & " -P" & _portno & " " & _database & " --max_allowed_packet=" & _maxallowedpacket & "M --default-character-set=utf8 < """ & _filename.Trim.Replace("\", "/") & """")
                .Close() : .Dispose()
            End With
...
#Region "Shared Functions"
        ...
        Public Shared Function Execute(ByVal connectionstring As String, ByVal commandtext As String) As Boolean
            ...
            If Directory.Exists(Application.StartupPath & "\tempsql") Then
                ...
                If EDI.EDIWriter.Write(Application.StartupPath & "\tempsql\query.sql", commandtext) Then
                    ...
                    Dim portno As String = ConnectionStringValue(connectionstring, ConnectionDetailEnum.Port)

                    b = Restore(server, database, uid, pwd, portno, Application.StartupPath & "\tempsql\query.sql")
        ...
        Public Overloads Shared Function Restore(ByVal server As String, ByVal database As String, ByVal userid As String, ByVal password As String, ByVal portno As String, ByVal filename As String) As Boolean
            Dim d As New Dump(server, database, userid, password, portno, filename)
            Dim b As Boolean = d.Import
            d.Dispose()
            Return b
        End Function
