...
namespace MetroFramework.Controls
{
    ...
    public class MetroDateTime : DateTimePicker, IMetroControl
    {
        ...
        private MetroDateTimeSize metroDateTimeSize = MetroDateTimeSize.Small;
        [DefaultValue(MetroDateTimeSize.Small)]
        [Category(MetroDefaults.PropertyCategory.Appearance)]
        ...
        private MetroDateTimeWeight metroDateTimeWeight = MetroDateTimeWeight.Light;
        [DefaultValue(MetroDateTimeWeight.Light)]
        [Category(MetroDefaults.PropertyCategory.Appearance)]
